import { Box, Card, CardActions, CardContent, styled, Theme, Typography } from "@mui/material";
...
export const MapToCustomerFeedback: FC = () =>(
    <>
        {
            customerFeedbackConfig.map(
                ({message, customerName}, index) =>(
                    <Card key={[customerName, index].join("-")} sx={{ backgroundColor: (theme: Theme) => theme.palette.background.default  }}>
                        <FeedbackIconStyled>
                        ...
                        <CardActions>
                            <Typography fontSize={14} color="GrayText" px={1}>{customerName}</Typography>
                        </CardActions>
                    </Card>
                )
            )
...
export const CustomerFeedbackStyled = styled(Box)(
    ({theme}) =>(
        {
            display: 'grid',
...
export const FeedbackIconStyled = styled(RowWrapper)(
    ({theme}) =>(
        {
...
export const FeedbackMessageBox = styled(Box)(
    ({theme}) =>(
        {
