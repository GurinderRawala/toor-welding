...
export const MapTopServicesGrid: FC = () => (
  <>
    {whatWeOfferConfig.servicesGrid.map(({ url, title, message }, index) => (
      <ColumnWrapper
        key={[url, index].join('-')}
        sx={{ justifyContent: 'flex-start', gap: 5, minHeight: 350 }}
      >
...
export const WhatWeOfferStyled = styled(ColumnWrapper)(({ theme }) => ({
