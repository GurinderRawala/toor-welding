    ...
    <WeldingWrapperStyled>
      <Card>
        <CardHeader
          ...
          title={
            <Typography variant="h4">{serviceCardConfig.title}</Typography>
          }
        />
        <CardMedia
          component="img"
      ...
      <WeldingContentStyled data-aos="fade-up">
        <Typography variant="h2">
          {aluminumWeldingContentConfig.title}
        </Typography>
...
export const MapToAluminiumWelding: FC = () => (
  <>
    {serviceListConfig.map((service, index) => (
...
export const WeldingWrapperStyled = styled(Box)(({ theme }) => ({
  display: 'grid',
...
export const OtherMaterialsStyled = styled(Box)(({ theme }) => ({
  display: 'grid',
...
export const WeldingContentStyled = styled(ColumnWrapper)(({ theme }) => ({
...
export const weldingMaterialContentConfig: WeldingMaterialContentConfig = {
  listOne: ['Carbon Steel', 'Low Alloy Steel', 'Stainless (All types)'],
  listTwo: ['Chromium', 'Nickle Alloy', 'Copper Alloy'],
}
