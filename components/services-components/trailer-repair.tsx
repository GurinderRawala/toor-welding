...
export const trailerRepairConfig: TrailerRepairConfig = {
  ...
  listOne: ['Box truck door panel repair', 'Truck overhead door repair'],
  listTwo: ['Rolling truck door repair', 'Truck door broken hinges'],
}
