    ...
    <>
      <PhotoViewerWrapper>
        <ResponsiveContainer sx={responsiveContainerExt}>
          <ResponsiveImage
            src={galleryImageConfig[currentImg].imgUrl}
            customStyles={responsiveImageExt}
...
export const PhotoViewerWrapper = styled(Box)(({ theme }) => ({
  display: 'flex',
...
export const FullImageViewerWrapper = styled(Box)(({ theme }) => ({
  position: 'fixed',
  top: 0,
  left: 0,
  width: '100%',
...
export const PhotoViewerButton = styled(Box)(({ theme }) => ({
  position: 'absolute',
  top: 0,
  height: '100%',
  fontSize: 26,
