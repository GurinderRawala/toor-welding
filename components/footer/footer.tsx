...
export const Footer: FC = () => {
  ...
  return (
    <>
      ...
      <CopyRightContainer>
        Copyright &copy;{new Date().getFullYear()} Toor Welding. All rights
        reserved
      </CopyRightContainer>
    </>
  )
...
export const AddressCard: FC = () => (
  <InnerWrapper sx={{ gap: 3 }}>
    ...
    <Box>
      ...
      <Typography>
        {[footerConfig.address.city, footerConfig.address.province].join(',')}{' '}
        {footerConfig.address.postalCode}
      </Typography>
    </Box>
  </InnerWrapper>
)
...
export const LinksCard: FC = () => (
  <InnerWrapper sx={{ gap: 2 }}>
    <MapNavLinks
      styles={{ color: (theme: Theme) => theme.palette.text.primary }}
    />
  </InnerWrapper>
)
